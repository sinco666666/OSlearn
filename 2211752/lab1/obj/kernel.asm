...
int kern_init(void) {
    ...
    memset(edata, 0, end - edata);
    80200022:	5b4000ef          	jal	ra,802005d6 <memset>
...
int cprintf(const char *fmt, ...) {
    ...
    vprintfmt((void *)cputch, &cnt, fmt, ap);
    80200094:	5c0000ef          	jal	ra,80200654 <vprintfmt>
    cnt = vcprintf(fmt, ap);
    va_end(ap);
    return cnt;
}
...
void clock_set_next_event(void) { sbi_set_timer(get_cycles() + timebase); }
    ...
    80200146:	0ab000ef          	jal	ra,802009f0 <sbi_set_timer>
}
...
void clock_set_next_event(void) { sbi_set_timer(get_cycles() + timebase); }
    ...
    8020016c:	0850006f          	j	802009f0 <sbi_set_timer>
...
void cons_putc(int c) { sbi_console_putchar((unsigned char)c); }
    ...
    80200176:	0610006f          	j	802009d6 <sbi_console_putchar>
...
void interrupt_handler(struct trapframe *tf) {
    ...
    80200444:	b0850513          	addi	a0,a0,-1272 # 80200f48 <etext+0x524>
    ...
    80200468:	0141                	addi	sp,sp,16
            sbi_shutdown();
    8020046a:	a345                	j	80200a0a <sbi_shutdown>
...
void exception_handler(struct trapframe *tf) {
    ...
    8020047a:	04f76263          	bltu	a4,a5,802004be <exception_handler+0x52>
    8020047e:	00001717          	auipc	a4,0x1
    80200482:	ba270713          	addi	a4,a4,-1118 # 80201020 <etext+0x5fc>
    80200486:	078a                	slli	a5,a5,0x2
    80200488:	97ba                	add	a5,a5,a4
    8020048a:	439c                	lw	a5,0(a5)
    8020048c:	97ba                	add	a5,a5,a4
    8020048e:	8782                	jr	a5
    ...
    80200494:	b0850513          	addi	a0,a0,-1272 # 80200f98 <etext+0x574>
    ...
    802004a4:	b2050513          	addi	a0,a0,-1248 # 80200fc0 <etext+0x59c>
...
static inline void trap_dispatch(struct trapframe *tf) {
    ...
    802004fe:	b7bd                	j	8020046c <exception_handler>
        interrupt_handler(tf);
...
strnlen(const char *s, size_t len) {
    size_t cnt = 0;
    802005ba:	4781                	li	a5,0
    while (cnt < len && *s ++ != '\0') {
    802005bc:	e589                	bnez	a1,802005c6 <strnlen+0xc>
    802005be:	a811                	j	802005d2 <strnlen+0x18>
        cnt ++;
    802005c0:	0785                	addi	a5,a5,1
    while (cnt < len && *s ++ != '\0') {
    802005c2:	00f58863          	beq	a1,a5,802005d2 <strnlen+0x18>
    802005c6:	00f50733          	add	a4,a0,a5
    802005ca:	00074703          	lbu	a4,0(a4)
    802005ce:	fb6d                	bnez	a4,802005c0 <strnlen+0x6>
    802005d0:	85be                	mv	a1,a5
    }
    return cnt;
}
    802005d2:	852e                	mv	a0,a1
    802005d4:	8082                	ret

00000000802005d6 <memset>:
memset(void *s, char c, size_t n) {
    ...
    char *p = s;
    while (n -- > 0) {
    802005d6:	ca01                	beqz	a2,802005e6 <memset+0x10>
    802005d8:	962a                	add	a2,a2,a0
    char *p = s;
    802005da:	87aa                	mv	a5,a0
        *p ++ = c;
    802005dc:	0785                	addi	a5,a5,1
    802005de:	feb78fa3          	sb	a1,-1(a5)
    while (n -- > 0) {
    802005e2:	fec79de3          	bne	a5,a2,802005dc <memset+0x6>
    }
    return s;
...
printnum(void (*putch)(int, void*), void *putdat,
    ...
    802005e8:	02069813          	slli	a6,a3,0x20
        unsigned long long num, unsigned base, int width, int padc) {
    802005ec:	7179                	addi	sp,sp,-48
    unsigned mod = do_div(result, base);
    802005ee:	02085813          	srli	a6,a6,0x20
        unsigned long long num, unsigned base, int width, int padc) {
    802005f2:	e052                	sd	s4,0(sp)
    unsigned mod = do_div(result, base);
    802005f4:	03067a33          	remu	s4,a2,a6
        unsigned long long num, unsigned base, int width, int padc) {
    802005f8:	f022                	sd	s0,32(sp)
    802005fa:	ec26                	sd	s1,24(sp)
    802005fc:	e84a                	sd	s2,16(sp)
    802005fe:	f406                	sd	ra,40(sp)
    80200600:	e44e                	sd	s3,8(sp)
    80200602:	84aa                	mv	s1,a0
    80200604:	892e                	mv	s2,a1
    ...
    if (num >= base) {
        ...
        while (-- width > 0)
    80200606:	fff7041b          	addiw	s0,a4,-1
    unsigned mod = do_div(result, base);
    8020060a:	2a01                	sext.w	s4,s4
    if (num >= base) {
    8020060c:	03067e63          	bgeu	a2,a6,80200648 <printnum+0x60>
    80200610:	89be                	mv	s3,a5
        while (-- width > 0)
    80200612:	00805763          	blez	s0,80200620 <printnum+0x38>
    80200616:	347d                	addiw	s0,s0,-1
            putch(padc, putdat);
    80200618:	85ca                	mv	a1,s2
    8020061a:	854e                	mv	a0,s3
    8020061c:	9482                	jalr	s1
        while (-- width > 0)
    8020061e:	fc65                	bnez	s0,80200616 <printnum+0x2e>
    }
    // then print this (the least significant) digit
    putch("0123456789abcdef"[mod], putdat);
    80200620:	1a02                	slli	s4,s4,0x20
    80200622:	00001797          	auipc	a5,0x1
    80200626:	a2e78793          	addi	a5,a5,-1490 # 80201050 <etext+0x62c>
    8020062a:	020a5a13          	srli	s4,s4,0x20
    8020062e:	9a3e                	add	s4,s4,a5
}
    80200630:	7402                	ld	s0,32(sp)
    putch("0123456789abcdef"[mod], putdat);
    80200632:	000a4503          	lbu	a0,0(s4)
}
    80200636:	70a2                	ld	ra,40(sp)
    80200638:	69a2                	ld	s3,8(sp)
    8020063a:	6a02                	ld	s4,0(sp)
    putch("0123456789abcdef"[mod], putdat);
    8020063c:	85ca                	mv	a1,s2
    8020063e:	87a6                	mv	a5,s1
}
    80200640:	6942                	ld	s2,16(sp)
    80200642:	64e2                	ld	s1,24(sp)
    80200644:	6145                	addi	sp,sp,48
    putch("0123456789abcdef"[mod], putdat);
    80200646:	8782                	jr	a5
        printnum(putch, putdat, result, base, width - 1, padc);
    80200648:	03065633          	divu	a2,a2,a6
    8020064c:	8722                	mv	a4,s0
    8020064e:	f9bff0ef          	jal	ra,802005e8 <printnum>
    80200652:	b7f9                	j	80200620 <printnum+0x38>

0000000080200654 <vprintfmt>:
 *
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
    80200654:	7119                	addi	sp,sp,-128
    80200656:	f4a6                	sd	s1,104(sp)
    80200658:	f0ca                	sd	s2,96(sp)
    8020065a:	ecce                	sd	s3,88(sp)
    8020065c:	e8d2                	sd	s4,80(sp)
    8020065e:	e4d6                	sd	s5,72(sp)
    80200660:	e0da                	sd	s6,64(sp)
    80200662:	fc5e                	sd	s7,56(sp)
    80200664:	f06a                	sd	s10,32(sp)
    80200666:	fc86                	sd	ra,120(sp)
    80200668:	f8a2                	sd	s0,112(sp)
    8020066a:	f862                	sd	s8,48(sp)
    8020066c:	f466                	sd	s9,40(sp)
    8020066e:	ec6e                	sd	s11,24(sp)
    80200670:	892a                	mv	s2,a0
    80200672:	84ae                	mv	s1,a1
    80200674:	8d32                	mv	s10,a2
    80200676:	8a36                	mv	s4,a3
    register int ch, err;
    ...
    80200678:	02500993          	li	s3,37
        ...
        char padc = ' ';
        width = precision = -1;
    8020067c:	5b7d                	li	s6,-1
    8020067e:	00001a97          	auipc	s5,0x1
    80200682:	a06a8a93          	addi	s5,s5,-1530 # 80201084 <etext+0x660>
        case 'e':
            err = va_arg(ap, int);
            if (err < 0) {
                err = -err;
    ...
    80200686:	00001b97          	auipc	s7,0x1
    8020068a:	bdab8b93          	addi	s7,s7,-1062 # 80201260 <error_string>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
    8020068e:	000d4503          	lbu	a0,0(s10)
    80200692:	001d0413          	addi	s0,s10,1
    80200696:	01350a63          	beq	a0,s3,802006aa <vprintfmt+0x56>
            if (ch == '\0') {
    8020069a:	c121                	beqz	a0,802006da <vprintfmt+0x86>
            putch(ch, putdat);
    8020069c:	85a6                	mv	a1,s1
        while ((ch = *(unsigned char *)fmt ++) != '%') {
    8020069e:	0405                	addi	s0,s0,1
            putch(ch, putdat);
    802006a0:	9902                	jalr	s2
        while ((ch = *(unsigned char *)fmt ++) != '%') {
    802006a2:	fff44503          	lbu	a0,-1(s0)
    802006a6:	ff351ae3          	bne	a0,s3,8020069a <vprintfmt+0x46>
        switch (ch = *(unsigned char *)fmt ++) {
    802006aa:	00044603          	lbu	a2,0(s0)
        char padc = ' ';
    802006ae:	02000793          	li	a5,32
        lflag = altflag = 0;
    802006b2:	4c81                	li	s9,0
    802006b4:	4881                	li	a7,0
        width = precision = -1;
    802006b6:	5c7d                	li	s8,-1
    802006b8:	5dfd                	li	s11,-1
    802006ba:	05500513          	li	a0,85
                if (ch < '0' || ch > '9') {
    802006be:	4825                	li	a6,9
        switch (ch = *(unsigned char *)fmt ++) {
    802006c0:	fdd6059b          	addiw	a1,a2,-35
    802006c4:	0ff5f593          	zext.b	a1,a1
    802006c8:	00140d13          	addi	s10,s0,1
    802006cc:	04b56263          	bltu	a0,a1,80200710 <vprintfmt+0xbc>
    802006d0:	058a                	slli	a1,a1,0x2
    802006d2:	95d6                	add	a1,a1,s5
    802006d4:	4194                	lw	a3,0(a1)
    802006d6:	96d6                	add	a3,a3,s5
    802006d8:	8682                	jr	a3
            for (fmt --; fmt[-1] != '%'; fmt --)
                /* do nothing */;
            break;
    ...
    802006da:	70e6                	ld	ra,120(sp)
    802006dc:	7446                	ld	s0,112(sp)
    802006de:	74a6                	ld	s1,104(sp)
    802006e0:	7906                	ld	s2,96(sp)
    802006e2:	69e6                	ld	s3,88(sp)
    802006e4:	6a46                	ld	s4,80(sp)
    802006e6:	6aa6                	ld	s5,72(sp)
    802006e8:	6b06                	ld	s6,64(sp)
    802006ea:	7be2                	ld	s7,56(sp)
    802006ec:	7c42                	ld	s8,48(sp)
    802006ee:	7ca2                	ld	s9,40(sp)
    802006f0:	7d02                	ld	s10,32(sp)
    802006f2:	6de2                	ld	s11,24(sp)
    802006f4:	6109                	addi	sp,sp,128
    802006f6:	8082                	ret
            padc = '0';
    802006f8:	87b2                	mv	a5,a2
            goto reswitch;
    802006fa:	00144603          	lbu	a2,1(s0)
        switch (ch = *(unsigned char *)fmt ++) {
    802006fe:	846a                	mv	s0,s10
    80200700:	00140d13          	addi	s10,s0,1
    80200704:	fdd6059b          	addiw	a1,a2,-35
    80200708:	0ff5f593          	zext.b	a1,a1
    8020070c:	fcb572e3          	bgeu	a0,a1,802006d0 <vprintfmt+0x7c>
            putch('%', putdat);
    80200710:	85a6                	mv	a1,s1
    80200712:	02500513          	li	a0,37
    80200716:	9902                	jalr	s2
            for (fmt --; fmt[-1] != '%'; fmt --)
    80200718:	fff44783          	lbu	a5,-1(s0)
    8020071c:	8d22                	mv	s10,s0
    8020071e:	f73788e3          	beq	a5,s3,8020068e <vprintfmt+0x3a>
    80200722:	ffed4783          	lbu	a5,-2(s10)
    80200726:	1d7d                	addi	s10,s10,-1
    80200728:	ff379de3          	bne	a5,s3,80200722 <vprintfmt+0xce>
    8020072c:	b78d                	j	8020068e <vprintfmt+0x3a>
                precision = precision * 10 + ch - '0';
    8020072e:	fd060c1b          	addiw	s8,a2,-48
                ch = *fmt;
    ...
    8020073c:	0006059b          	sext.w	a1,a2
                if (ch < '0' || ch > '9') {
    80200740:	02d86463          	bltu	a6,a3,80200768 <vprintfmt+0x114>
                ch = *fmt;
    80200744:	00144603          	lbu	a2,1(s0)
                precision = precision * 10 + ch - '0';
    80200748:	002c169b          	slliw	a3,s8,0x2
    8020074c:	0186873b          	addw	a4,a3,s8
    80200750:	0017171b          	slliw	a4,a4,0x1
    80200754:	9f2d                	addw	a4,a4,a1
                if (ch < '0' || ch > '9') {
    80200756:	fd06069b          	addiw	a3,a2,-48
            for (precision = 0; ; ++ fmt) {
    8020075a:	0405                	addi	s0,s0,1
                precision = precision * 10 + ch - '0';
    8020075c:	fd070c1b          	addiw	s8,a4,-48
                ch = *fmt;
    80200760:	0006059b          	sext.w	a1,a2
                if (ch < '0' || ch > '9') {
    80200764:	fed870e3          	bgeu	a6,a3,80200744 <vprintfmt+0xf0>
            if (width < 0)
    80200768:	f40ddce3          	bgez	s11,802006c0 <vprintfmt+0x6c>
                width = precision, precision = -1;
    8020076c:	8de2                	mv	s11,s8
    8020076e:	5c7d                	li	s8,-1
    80200770:	bf81                	j	802006c0 <vprintfmt+0x6c>
            if (width < 0)
    80200772:	fffdc693          	not	a3,s11
    80200776:	96fd                	srai	a3,a3,0x3f
    80200778:	00ddfdb3          	and	s11,s11,a3
        switch (ch = *(unsigned char *)fmt ++) {
    8020077c:	00144603          	lbu	a2,1(s0)
    80200780:	2d81                	sext.w	s11,s11
    80200782:	846a                	mv	s0,s10
            goto reswitch;
    80200784:	bf35                	j	802006c0 <vprintfmt+0x6c>
            precision = va_arg(ap, int);
    80200786:	000a2c03          	lw	s8,0(s4)
        switch (ch = *(unsigned char *)fmt ++) {
    8020078a:	00144603          	lbu	a2,1(s0)
            precision = va_arg(ap, int);
    8020078e:	0a21                	addi	s4,s4,8
        switch (ch = *(unsigned char *)fmt ++) {
    80200790:	846a                	mv	s0,s10
            goto process_precision;
    80200792:	bfd9                	j	80200768 <vprintfmt+0x114>
    if (lflag >= 2) {
    80200794:	4705                	li	a4,1
            precision = va_arg(ap, int);
    80200796:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
    8020079a:	01174463          	blt	a4,a7,802007a2 <vprintfmt+0x14e>
    else if (lflag) {
    8020079e:	1a088e63          	beqz	a7,8020095a <vprintfmt+0x306>
        return va_arg(*ap, unsigned long);
    802007a2:	000a3603          	ld	a2,0(s4)
    802007a6:	46c1                	li	a3,16
    802007a8:	8a2e                	mv	s4,a1
            printnum(putch, putdat, num, base, width, padc);
    802007aa:	2781                	sext.w	a5,a5
    802007ac:	876e                	mv	a4,s11
    802007ae:	85a6                	mv	a1,s1
    802007b0:	854a                	mv	a0,s2
    802007b2:	e37ff0ef          	jal	ra,802005e8 <printnum>
            break;
    802007b6:	bde1                	j	8020068e <vprintfmt+0x3a>
            putch(va_arg(ap, int), putdat);
    802007b8:	000a2503          	lw	a0,0(s4)
    802007bc:	85a6                	mv	a1,s1
    802007be:	0a21                	addi	s4,s4,8
    802007c0:	9902                	jalr	s2
            break;
    802007c2:	b5f1                	j	8020068e <vprintfmt+0x3a>
    if (lflag >= 2) {
    802007c4:	4705                	li	a4,1
            precision = va_arg(ap, int);
    802007c6:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
    802007ca:	01174463          	blt	a4,a7,802007d2 <vprintfmt+0x17e>
    else if (lflag) {
    802007ce:	18088163          	beqz	a7,80200950 <vprintfmt+0x2fc>
        return va_arg(*ap, unsigned long);
    802007d2:	000a3603          	ld	a2,0(s4)
    802007d6:	46a9                	li	a3,10
    802007d8:	8a2e                	mv	s4,a1
    802007da:	bfc1                	j	802007aa <vprintfmt+0x156>
        switch (ch = *(unsigned char *)fmt ++) {
    802007dc:	00144603          	lbu	a2,1(s0)
            altflag = 1;
    802007e0:	4c85                	li	s9,1
        switch (ch = *(unsigned char *)fmt ++) {
    802007e2:	846a                	mv	s0,s10
            goto reswitch;
    802007e4:	bdf1                	j	802006c0 <vprintfmt+0x6c>
            putch(ch, putdat);
    802007e6:	85a6                	mv	a1,s1
    802007e8:	02500513          	li	a0,37
    802007ec:	9902                	jalr	s2
            break;
    802007ee:	b545                	j	8020068e <vprintfmt+0x3a>
        switch (ch = *(unsigned char *)fmt ++) {
    802007f0:	00144603          	lbu	a2,1(s0)
            lflag ++;
    802007f4:	2885                	addiw	a7,a7,1
        switch (ch = *(unsigned char *)fmt ++) {
    802007f6:	846a                	mv	s0,s10
            goto reswitch;
    802007f8:	b5e1                	j	802006c0 <vprintfmt+0x6c>
    if (lflag >= 2) {
    802007fa:	4705                	li	a4,1
            precision = va_arg(ap, int);
    802007fc:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
    80200800:	01174463          	blt	a4,a7,80200808 <vprintfmt+0x1b4>
    else if (lflag) {
    80200804:	14088163          	beqz	a7,80200946 <vprintfmt+0x2f2>
        return va_arg(*ap, unsigned long);
    80200808:	000a3603          	ld	a2,0(s4)
    8020080c:	46a1                	li	a3,8
    8020080e:	8a2e                	mv	s4,a1
    80200810:	bf69                	j	802007aa <vprintfmt+0x156>
            putch('0', putdat);
    80200812:	03000513          	li	a0,48
    80200816:	85a6                	mv	a1,s1
    80200818:	e03e                	sd	a5,0(sp)
    ...
    80200824:	0a21                	addi	s4,s4,8
            goto number;
    80200826:	6782                	ld	a5,0(sp)
    80200828:	46c1                	li	a3,16
            num = (unsigned long long)va_arg(ap, void *);
    8020082a:	ff8a3603          	ld	a2,-8(s4)
            goto number;
    8020082e:	bfb5                	j	802007aa <vprintfmt+0x156>
            if ((p = va_arg(ap, char *)) == NULL) {
    80200830:	000a3403          	ld	s0,0(s4)
    80200834:	008a0713          	addi	a4,s4,8
    80200838:	e03a                	sd	a4,0(sp)
    8020083a:	14040263          	beqz	s0,8020097e <vprintfmt+0x32a>
            if (width > 0 && padc != '-') {
    8020083e:	0fb05763          	blez	s11,8020092c <vprintfmt+0x2d8>
    80200842:	02d00693          	li	a3,45
    80200846:	0cd79163          	bne	a5,a3,80200908 <vprintfmt+0x2b4>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
    8020084a:	00044783          	lbu	a5,0(s0)
    8020084e:	0007851b          	sext.w	a0,a5
    80200852:	cf85                	beqz	a5,8020088a <vprintfmt+0x236>
    80200854:	00140a13          	addi	s4,s0,1
                if (altflag && (ch < ' ' || ch > '~')) {
    80200858:	05e00413          	li	s0,94
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
    8020085c:	000c4563          	bltz	s8,80200866 <vprintfmt+0x212>
    80200860:	3c7d                	addiw	s8,s8,-1
    80200862:	036c0263          	beq	s8,s6,80200886 <vprintfmt+0x232>
                    putch('?', putdat);
    80200866:	85a6                	mv	a1,s1
                if (altflag && (ch < ' ' || ch > '~')) {
    80200868:	0e0c8e63          	beqz	s9,80200964 <vprintfmt+0x310>
    8020086c:	3781                	addiw	a5,a5,-32
    8020086e:	0ef47b63          	bgeu	s0,a5,80200964 <vprintfmt+0x310>
                    putch('?', putdat);
    80200872:	03f00513          	li	a0,63
    80200876:	9902                	jalr	s2
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
    80200878:	000a4783          	lbu	a5,0(s4)
    8020087c:	3dfd                	addiw	s11,s11,-1
    8020087e:	0a05                	addi	s4,s4,1
    80200880:	0007851b          	sext.w	a0,a5
    80200884:	ffe1                	bnez	a5,8020085c <vprintfmt+0x208>
            for (; width > 0; width --) {
    80200886:	01b05963          	blez	s11,80200898 <vprintfmt+0x244>
    ...
    80200892:	9902                	jalr	s2
            for (; width > 0; width --) {
    80200894:	fe0d9be3          	bnez	s11,8020088a <vprintfmt+0x236>
            if ((p = va_arg(ap, char *)) == NULL) {
    80200898:	6a02                	ld	s4,0(sp)
    8020089a:	bbd5                	j	8020068e <vprintfmt+0x3a>
    if (lflag >= 2) {
    8020089c:	4705                	li	a4,1
            precision = va_arg(ap, int);
    8020089e:	008a0c93          	addi	s9,s4,8
    if (lflag >= 2) {
    802008a2:	01174463          	blt	a4,a7,802008aa <vprintfmt+0x256>
    else if (lflag) {
    802008a6:	08088d63          	beqz	a7,80200940 <vprintfmt+0x2ec>
        return va_arg(*ap, long);
    802008aa:	000a3403          	ld	s0,0(s4)
            if ((long long)num < 0) {
    802008ae:	0a044d63          	bltz	s0,80200968 <vprintfmt+0x314>
            num = getint(&ap, lflag);
    802008b2:	8622                	mv	a2,s0
    802008b4:	8a66                	mv	s4,s9
    802008b6:	46a9                	li	a3,10
    802008b8:	bdcd                	j	802007aa <vprintfmt+0x156>
            err = va_arg(ap, int);
    802008ba:	000a2783          	lw	a5,0(s4)
            if (err > MAXERROR || (p = error_string[err]) == NULL) {
    802008be:	4719                	li	a4,6
            err = va_arg(ap, int);
    802008c0:	0a21                	addi	s4,s4,8
            if (err < 0) {
    802008c2:	41f7d69b          	sraiw	a3,a5,0x1f
    802008c6:	8fb5                	xor	a5,a5,a3
    802008c8:	40d786bb          	subw	a3,a5,a3
            if (err > MAXERROR || (p = error_string[err]) == NULL) {
    802008cc:	02d74163          	blt	a4,a3,802008ee <vprintfmt+0x29a>
    802008d0:	00369793          	slli	a5,a3,0x3
    802008d4:	97de                	add	a5,a5,s7
    802008d6:	639c                	ld	a5,0(a5)
    802008d8:	cb99                	beqz	a5,802008ee <vprintfmt+0x29a>
                printfmt(putch, putdat, "%s", p);
    802008da:	86be                	mv	a3,a5
    802008dc:	00000617          	auipc	a2,0x0
    802008e0:	7a460613          	addi	a2,a2,1956 # 80201080 <etext+0x65c>
    802008e4:	85a6                	mv	a1,s1
    802008e6:	854a                	mv	a0,s2
    802008e8:	0ce000ef          	jal	ra,802009b6 <printfmt>
    802008ec:	b34d                	j	8020068e <vprintfmt+0x3a>
                printfmt(putch, putdat, "error %d", err);
    802008ee:	00000617          	auipc	a2,0x0
    802008f2:	78260613          	addi	a2,a2,1922 # 80201070 <etext+0x64c>
    802008f6:	85a6                	mv	a1,s1
    802008f8:	854a                	mv	a0,s2
    802008fa:	0bc000ef          	jal	ra,802009b6 <printfmt>
    802008fe:	bb41                	j	8020068e <vprintfmt+0x3a>
                p = "(null)";
    80200900:	00000417          	auipc	s0,0x0
    80200904:	76840413          	addi	s0,s0,1896 # 80201068 <etext+0x644>
                for (width -= strnlen(p, precision); width > 0; width --) {
    80200908:	85e2                	mv	a1,s8
    8020090a:	8522                	mv	a0,s0
    8020090c:	e43e                	sd	a5,8(sp)
    8020090e:	cadff0ef          	jal	ra,802005ba <strnlen>
    80200912:	40ad8dbb          	subw	s11,s11,a0
    80200916:	01b05b63          	blez	s11,8020092c <vprintfmt+0x2d8>
                    putch(padc, putdat);
    8020091a:	67a2                	ld	a5,8(sp)
    8020091c:	00078a1b          	sext.w	s4,a5
                for (width -= strnlen(p, precision); width > 0; width --) {
    80200920:	3dfd                	addiw	s11,s11,-1
                    putch(padc, putdat);
    80200922:	85a6                	mv	a1,s1
    80200924:	8552                	mv	a0,s4
    80200926:	9902                	jalr	s2
                for (width -= strnlen(p, precision); width > 0; width --) {
    80200928:	fe0d9ce3          	bnez	s11,80200920 <vprintfmt+0x2cc>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
    8020092c:	00044783          	lbu	a5,0(s0)
    80200930:	00140a13          	addi	s4,s0,1
    80200934:	0007851b          	sext.w	a0,a5
    80200938:	d3a5                	beqz	a5,80200898 <vprintfmt+0x244>
                if (altflag && (ch < ' ' || ch > '~')) {
    8020093a:	05e00413          	li	s0,94
    8020093e:	bf39                	j	8020085c <vprintfmt+0x208>
        return va_arg(*ap, int);
    80200940:	000a2403          	lw	s0,0(s4)
    80200944:	b7ad                	j	802008ae <vprintfmt+0x25a>
        return va_arg(*ap, unsigned int);
    80200946:	000a6603          	lwu	a2,0(s4)
    8020094a:	46a1                	li	a3,8
    8020094c:	8a2e                	mv	s4,a1
    8020094e:	bdb1                	j	802007aa <vprintfmt+0x156>
    80200950:	000a6603          	lwu	a2,0(s4)
    80200954:	46a9                	li	a3,10
    80200956:	8a2e                	mv	s4,a1
    80200958:	bd89                	j	802007aa <vprintfmt+0x156>
    8020095a:	000a6603          	lwu	a2,0(s4)
    8020095e:	46c1                	li	a3,16
    80200960:	8a2e                	mv	s4,a1
    80200962:	b5a1                	j	802007aa <vprintfmt+0x156>
                    putch(ch, putdat);
    80200964:	9902                	jalr	s2
    80200966:	bf09                	j	80200878 <vprintfmt+0x224>
                putch('-', putdat);
    80200968:	85a6                	mv	a1,s1
    8020096a:	02d00513          	li	a0,45
    8020096e:	e03e                	sd	a5,0(sp)
    80200970:	9902                	jalr	s2
                num = -(long long)num;
    80200972:	6782                	ld	a5,0(sp)
    80200974:	8a66                	mv	s4,s9
    80200976:	40800633          	neg	a2,s0
    8020097a:	46a9                	li	a3,10
    8020097c:	b53d                	j	802007aa <vprintfmt+0x156>
            if (width > 0 && padc != '-') {
    8020097e:	03b05163          	blez	s11,802009a0 <vprintfmt+0x34c>
    80200982:	02d00693          	li	a3,45
    80200986:	f6d79de3          	bne	a5,a3,80200900 <vprintfmt+0x2ac>
                p = "(null)";
    8020098a:	00000417          	auipc	s0,0x0
    8020098e:	6de40413          	addi	s0,s0,1758 # 80201068 <etext+0x644>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
    80200992:	02800793          	li	a5,40
    80200996:	02800513          	li	a0,40
    8020099a:	00140a13          	addi	s4,s0,1
    8020099e:	bd6d                	j	80200858 <vprintfmt+0x204>
    802009a0:	00000a17          	auipc	s4,0x0
    802009a4:	6c9a0a13          	addi	s4,s4,1737 # 80201069 <etext+0x645>
    802009a8:	02800513          	li	a0,40
    802009ac:	02800793          	li	a5,40
                if (altflag && (ch < ' ' || ch > '~')) {
    802009b0:	05e00413          	li	s0,94
    802009b4:	b565                	j	8020085c <vprintfmt+0x208>
...
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
    ...
    vprintfmt(putch, putdat, fmt, ap);
    802009cc:	c89ff0ef          	jal	ra,80200654 <vprintfmt>
}
...
uint64_t sbi_call(uint64_t sbi_type, uint64_t arg0, uint64_t arg1, uint64_t arg2) {
    ...
    802009dc:	62873703          	ld	a4,1576(a4) # 80204000 <SBI_CONSOLE_PUTCHAR>
...
00000000802009f0 <sbi_set_timer>:
    __asm__ volatile (
    802009f0:	4781                	li	a5,0
    802009f2:	00003717          	auipc	a4,0x3
    802009f6:	63673703          	ld	a4,1590(a4) # 80204028 <SBI_SET_TIMER>
...
0000000080200a0a <sbi_shutdown>:
    ...
    80200a0c:	00003717          	auipc	a4,0x3
    80200a10:	5fc73703          	ld	a4,1532(a4) # 80204008 <SBI_SHUTDOWN>
    80200a14:	88ba                	mv	a7,a4
    80200a16:	853e                	mv	a0,a5
    80200a18:	85be                	mv	a1,a5
    80200a1a:	863e                	mv	a2,a5
    80200a1c:	00000073          	ecall
    80200a20:	87aa                	mv	a5,a0
